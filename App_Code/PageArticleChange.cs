...
/// <summary>
///PageArticleChange 的摘要说明
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
//若要允许使用 ASP.NET AJAX 从脚本中调用此 Web 服务，请取消对下行的注释。 
[System.Web.Script.Services.ScriptService]
public class PageArticleChange : System.Web.Services.WebService {
    ...
    public string PageArticleChangeData(string sType, int nItemNum)
    {
        ...
        string qConditon = " where articletag = " + "'" + sType + "'";
        ...
        try
        {
            if (reader.HasRows)     //查询到结果
            {
                while (reader.Read())
                {
                    ...
                    str = str + reader[4].ToString() + "#"; //href
                    str = str + reader[5].ToString() + "#"; //time
