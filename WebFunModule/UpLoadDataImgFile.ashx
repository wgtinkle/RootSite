<%@ WebHandler Language="C#" Class="UpLoadDataImgFile" %>
...
public class UpLoadDataImgFile : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (context.Request.Files.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(file.FileName))
            {
                ...
                {
                    string path = HttpRuntime.AppDomainAppPath + "PageData\\PageDataImg\\" + filename; //获取当前的路径
                    file.SaveAs(path);
                    sState.msg = "PageData/PageDataImg/" + filename;
                }
            }
        }
